...
export class TeamsController {
  ...
  create(@Request() req: { user: { userId: string } }, @Body() createTeamDto: CreateTeamDto) {
  ...
  addPokemon(
    ...
    return this.teamsService.addPokemon(id, req.user.userId, addPokemonDto);
  }
  ...
  updatePokemon(
    ...
    return this.teamsService.updatePokemon(teamId, pokemonId, req.user.userId, updatePokemonDto);
  }
  ...
  removePokemon(
    ...
    return this.teamsService.removePokemon(teamId, pokemonId, req.user.userId);
  }
}
